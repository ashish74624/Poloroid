...
export default function Register() {
  ...
  return (
    <>
      ...
      <h3 className=' text-white text-2xl md:text-4xl lg:text-5xl overflow-x-hidden overflow-y-scroll pb-32'>Welcome to <span className={`${Comf.className}`}>polaroid</span> | Register</h3>
