...
<div className="w-[20vw] bg-white border border-gray-200 rounded-lg shadow">
    ...
    <div className="flex flex-col items-center pb-10">
        ...
        <div className="flex mt-4 space-x-3 md:mt-6">
            <a href='/' className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-[#58b8e8] rounded-lg hover:bg-[#4cc3ff] focus:ring-4 focus:outline-none focus:ring-blue-300 ">Add friend</a>
