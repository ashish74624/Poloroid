    ...
    <>
    {
        ...
        <>
            <form action={handleRegister}>
                ...
                <input name ='profileImage' className="block w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer  bg-[#efd3cd] focus:outline-none" id="file_input" type="file" 
