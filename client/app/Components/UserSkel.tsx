     ...
     <div className=" animate-pulse w-[16vw] bg-white border border-gray-300 rounded-lg shadow  ">
            <div className="flex flex-col items-center pb-10">
                ...
                <div className="flex mt-2 space-x-3">
                    <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-[#58b8e8] rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 "
                    >Add friend</button>
