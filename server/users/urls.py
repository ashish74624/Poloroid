...
urlpatterns = [
    ...
    path(
        "getFriendSuggestions/<str:email>/",
        views.get_friends_suggestion,
        name="get_friends_suggestion",
    ),
    path("addFriend/<str:email>/", views.add_friend, name="add_friend"),
    path(
        "removeSuggestion/<int:id>/", views.remove_suggestion, name="remove_suggestion"
    ),
